...
import sys, os
#from pylab import *
import matplotlib.pylab as pylab #dani modification
from numpy import *
import scipy
import operator
...
def segmentColorImageSRM(file):
    ...
    image = scipy.ndimage.imread(file, mode='RGB')
...
#outputPath = '/Users/dani11/Dropbox/prog/Python/Meryl/fiberDetection/hrish.tif'
    #segmentColorImageEGBS(sys.argv[1])
    segmentColorImageSRM('/Users/dani11/Dropbox/prog/Python/Meryl/fiberDetection/hrish.tif')#sys.argv[1])
